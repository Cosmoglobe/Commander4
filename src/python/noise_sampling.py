...
def sample_noise_PS_params(n_corr: NDArray, sigma0: float, f_samp: float, alpha_start: float, freq_max=3.0, n_grid=100, n_burnin=5) -> tuple[float,float]:
...
def inefficient_corr_noise_realization_with_gaps(TOD: NDArray, mask: NDArray[np.bool_], sigma0: float, C_corr_inv: NDArray, err_tol=1e-12, max_iter=300, rnd_seed=None) -> NDArray:
