...
#         # If the assigned value is a Params object, inject the key as its name
#         if isinstance(value, Params):
#             object.__setattr__(value, "_name", key)
#         # If it's a dict/Bunch, convert it to Params and inject the name
#         elif isinstance(value, (dict, Bunch)):
#             value = Params(value, name=key)
            
#         super().__setitem__(key, value)

#     def __setattr__(self, key, value):
#         # Allow private attributes to pass through normally
#         if key.startswith("_"):
