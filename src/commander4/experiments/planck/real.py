"""TOD reader for Planck LFI/HFI flight data (``experiment_id: planck``)."""
import logging
import numpy as np
import healpy as hp
import h5py
...
def tod_reader(band_comm: MPI.Comm, my_experiment: str, my_band: Bunch, all_det_names: list[str],
    ...
    """Read this rank's scans for one Planck band from its HDF5 scan files.
