...
class DetectorTOD:
    def __init__ (self, tod, pix_encoded, psi_encoded, nside, data_nside, fsamp,
                  orb_dir_vec, huffman_tree, huffman_symbols, npsi, processing_mask_map,
                  ntod_original, flag_encoded=None, flag_bitmask=None, pix_is_compressed=True, psi_is_compressed=True):
